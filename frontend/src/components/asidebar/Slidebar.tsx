...
export function Sidebar() {
  ...
  return (
    <aside className="h-screen w-64 bg-white border-r border-gray-100 fixed left-0 top-0 flex flex-col dark:bg-gray-900 border-gray-100 dark:border-gray-800">
      {/* Logo */}
      ...
      <div className="px-4 py-4 border-t border-gray-100 flex flex-col gap-2">
        <div className="flex items-center gap-2.5">
          <div className="w-7 h-7 rounded-full bg-purple-100 flex items-center justify-center text-primary text-xs font-semibold shrink-0 dark:border-gray-800">
            U
          </div>
        ...
        <button
          ...
          className="w-full text-left px-3 py-2 text-sm text-red-500 hover:bg-red-50 rounded-lg transition-colors text-red-500 hover:bg-red-50 dark:hover:bg-red-950"
        >
          Log out
        </button>
      </div>
